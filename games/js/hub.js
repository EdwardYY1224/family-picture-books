...
(function () {
  ...
  const TILES = [
    { href: "position-adventure.html", icon: "bird", tone: "coral", resumeId: null,
  ...
  TILES.forEach((tile) => {
    ...
    mark.append(window.KidIcons.el(tile.icon, "icon-svg"));
